...
CLASS kernel_create_data_handle IMPLEMENTATION.
  ...
  METHOD call.
    ...
    " patch: every generic type description raises, as on a real system
  ...
  METHOD ref.
    ...
    " patch: REF TO <interface> is described by cl_abap_intfdescr, so the common
    " super class cl_abap_objectdescr is the right type here, not cl_abap_classdescr
    DATA lo_classdescr    TYPE REF TO cl_abap_objectdescr.
