...
* set parameters of methods
    ...
    " patch: fully generic parameter types are generic descriptions, not a C LENGTH 4
    ELSEIF lv_type_name = 'AnyType'.
      <parameter>-type_kind = cl_abap_typedescr=>typekind_any.
      <ptype>-type_kind = cl_abap_typedescr=>typekind_any.
    ELSEIF lv_type_name = 'DataType'.
      <parameter>-type_kind = cl_abap_typedescr=>typekind_data.
...
"     WRITE '@KERNEL   } else {'.
  ...
  METHOD get_method_parameter_type.
    ...
    " patch: fully generic parameter types
    ELSEIF ls_row-type_kind = cl_abap_typedescr=>typekind_any.
      CREATE OBJECT p_descr_ref TYPE cl_abap_elemdescr.
      p_descr_ref->absolute_name = '\TYPE=ANY'.
      p_descr_ref->kind = cl_abap_elemdescr=>kind_elem.
      p_descr_ref->type_kind = cl_abap_typedescr=>typekind_any.
    ELSEIF ls_row-type_kind = cl_abap_typedescr=>typekind_data.
      CREATE OBJECT p_descr_ref TYPE cl_abap_elemdescr.
      p_descr_ref->absolute_name = '\TYPE=DATA'.
      p_descr_ref->kind = cl_abap_elemdescr=>kind_elem.
      p_descr_ref->type_kind = cl_abap_typedescr=>typekind_data.
    ELSEIF ls_row-type_kind = cl_abap_typedescr=>typekind_simple.
      CREATE OBJECT p_descr_ref TYPE cl_abap_elemdescr.
